<div align="center">
  ...
  ### A defensive cybersecurity specialist, security analyst, sysadmin, software engineer & web dev
  ...
  <img src="./efrei-cyber-hub.jpg" alt="Description" width="300"/>
...
<details>
  ...
  * Rewriting [all software in my linux distribution in pure amd64 assembly](https://github.com/Pingasmaster/white) by hand to make it faster (not a joke) so an OS can finally do modern work but also feel as snappy as windows 95 again.
  * Creating [my own future-proof linux distribution](https://github.com/Pingasmaster/apexos) with near-native support for windows apps executing from the file manager as a Proof of Concept. I may rename ApexOS into Linux 95 sooner or later.
...
<details>
  ...
  In the end, everyone is a beginner, and has more to learn. If you like my mindset but my current skills don't quite align with what you do right now, know that I got where I am by being able and willing to learn new things fast and well. I always stay committed to do my very best never and never settle into a "oh, I know this like the back of my hand" lazyness. The best thing about learning is that you can recognize your own mistakes so you make less of them later!
